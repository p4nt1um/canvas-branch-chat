...
> **创建时间**: 2026-07-06
 > **更新时间**: 2026-07-15 (v12 — #14/#15/#22 完成)
 > **状态**: ✅ v0.1.0 已发布（P0/P1/M3.5/M4 全部完成）→ 🚧 P2 开发中（i18n 待做）
...
| 14 | 对话回放 | 按时间顺序逐步高亮节点，回放对话树演变 | ✅ 完成 |
| 15 | 上下文裁剪（分级压缩） | assistant 近全远摘，user 全发；金字塔摘要引导 | ✅ 完成 |
| ~~16~~ | ~~分叉框架预设~~ | ~~13 个内置框架，下拉框选择~~ | ✅ 完成 |
| ~~21-1~~ | ~~Skills 阶段 1~~ | ~~`/skill-name` + SKILL.md 注入~~ | ✅ 完成 |
| 22 | 智能追问 | 追问弹窗内提取候选问题，取并集提交 | ✅ 完成 |
| 23 | 中英双语 (i18n) | UI 文案中英双语，支持国际化 | ⬜ |
| ~~16~~ | ~~角色扮演分叉~~ | 已并入 P1 #5 | — |
...
| 21-2 | Skills 阶段 2：Claude CLI Provider | spawn `claude` CLI，完整 skill 执行（需用户本地装 CLI） |
